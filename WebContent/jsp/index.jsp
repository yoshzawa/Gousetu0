...
<div id="main" class="box">
    ...
    <div id="header">
        ...
        <!-- Logotyp -->
        <h1 id="logo"><a href="./" title="合説事前登録システム">合説事前登録システム</a></h1>
        <hr class="noscreen" />          
     ...
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                ...
                <li id="active"><a href="#">Photos<span class="tab-l"></span><span class="tab-r"></span></a></li>
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">管理者向け</a></span></h2>
                <p class="info noprint">
                    <span class="date">2019-12-06</span><span class="noscreen">,</span>
                </p>

                <p>データベースの確認、初期化ができます</p>
                <p><a href="./DBCheck">データベースのテーブルが作成されているか、データが入っているかを確認する</a></p>
                <p><a href="./DbInit">データベースを作り直し、初期データだけが入った状態にする</a></p>
